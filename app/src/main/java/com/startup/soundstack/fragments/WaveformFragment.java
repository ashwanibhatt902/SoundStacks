...
import com.startup.soundstack.soundfile.SongMetadataReader;
...
import com.startup.soundstack.view.MarkerView;
import com.startup.soundstack.view.WaveformView;
...
public abstract class WaveformFragment extends Fragment implements MarkerView.MarkerListener, WaveformView.WaveformListener {
    ...
    protected long mRecordingLastUpdateTime;
    protected boolean mRecordingKeepGoing;
    protected double mRecordingTime;
...
//    protected TextView mInfo;
    ...
    protected Thread mLoadSoundFileThread;
    protected Thread mRecordAudioThread;
    protected Thread mSaveSoundFileThread;
    ...
    //Custom
    protected AutoCompleteTextView mTags = null;
    protected EditText mName = null;
    protected CustomSpinner mCatSpinner = null;
    protected AutoLabelUI mAutoLabelUI = null;
    protected TextInputLayout mtextInputName = null;
    protected TextInputLayout mTextInputTag = null;
    protected CustomSpinnerAdapter mSpinnerAdapter = null;
    protected List<String> mTagList = null;
    protected View mParent = null;
//    protected Tags mTagsInfo = null;
    //
...
//    }
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (mFilename == null) {
            mSoundFile = HomeActivity.sSoundFile;
        }
        else {
            mSoundFile = null;
        }
...
//        }
    ...
    protected abstract void afterSaveSound(String title,
                                           String finalOutPath,
                                           int duration,
                                           byte [] bytes);

    protected void closeThread(Thread thread) {
...
//        setTitle(titleLabel);
        ...
        mProgressDialog.setButton(Dialog.BUTTON_NEGATIVE, "Cancel", new DialogInterface.OnClickListener() {
            @Override
...
//            showFinalAlert(e, R.string.play_error);
     ...
     */
//    protected void showFinalAlert(Exception e, CharSequence message) {
//        CharSequence title;
//        if (e != null) {
...
//    }
//
//    protected void showFinalAlert(Exception e, int messageResourceId) {
//        showFinalAlert(e, getResources().getText(messageResourceId));
//    }

//    protected String makeRingtoneFilename(CharSequence title, String extension) {
//        String subdir;
...
//    }
    ...
    protected void saveRingtone(final CharSequence title) {
        ...
        if (duration > 90 ) {
            String msg = getString(R.string.ninetySecAllowed) + " " +Integer.toString(duration) + " sec";
            Snackbar.make(mParent, msg, Snackbar.LENGTH_LONG).show();
            return;
        }
        ...
        mSaveSoundFileThread = new Thread() {
            public void run() {
                // Try AAC first.
                String outPath = Utility.getSoundPath(title, ".m4a");
                if (outPath == null) {
                    Runnable runnable = new Runnable() {
                        public void run() {
                            showAlert("Error writing file");
                        }
                    };
                    mHandler.post(runnable);
                    return;
                ...
                if (fallbackToWAV) {
                    outPath = Utility.getSoundPath(title, ".wav");
                    if (outPath == null) {
                        Runnable runnable = new Runnable() {
                            public void run() {
                                showAlert("Error writing file");
...
//                        });
                        ...
                        Runnable runnable = new Runnable() {
                            public void run() {
                                showAlert(finalErrorMessage.toString());
                            }
                        };
                        mHandler.post(runnable);
                        return;
...
//    protected void afterSavingRingtone(CharSequence title,
//                                     String outPath,
//                                     int duration) {
//        File outFile = new File(outPath);
...
//    }
    ...
    protected void chooseContactForRingtone(Uri uri) {
        try {
